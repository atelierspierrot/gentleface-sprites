...
//-->
    <!--[if lt IE 5.5]>
    	<link rel="stylesheet" href="assets/styles_ie_lt5.5.css" />
    <![endif]-->
    <!--[if gte IE 5.5]>
    	<link rel="stylesheet" href="assets/styles_ie_gte5.5.css" />
    <![endif]-->
<style type="text/css">
...
<body>
    ...
    <header id="top" role="banner">
        <hgroup>
            ...
            <h2 class="slogan">The <strong>UNOFFICIAL</strong> sprites - Original icons work from <a href="http://www.gentleface.com/" title="www.gentleface.com">www.gentleface.com</a>.</h2>
        </hgroup>
        <div class="hat">
            <p>This page is a demonstration/presentation of the CSS sprites constructed on the <a href="http://www.gentleface.com/free_icon_set.html" title="See online">Gentleface free web-icons set</a>. The original set of icons is proposed under <a href="http://creativecommons.org/licenses/by-nc/3.0/" title="Read the license online">Creative Commons named "Attribution - Non Commercial"</a> license, free of use for NON COMMERCIAL usage as long as you mention the image credits to Gentleface.</p>
            <p>To learn more about "CSS sprites" conception, see <a href="http://en.wikipedia.org/wiki/Sprite_%28computer_graphics%29#Sprites_by_CSS" title="See online on wikipedia.com">Sprite (computer graphics) [wikipedia]</a>.</p>
            <p>The sprites were generated with the help of <a href="http://spritegen.website-performance.org/" title="See online">website-performance.org</a> and are <a href="http://jigsaw.w3.org/css-validator/" title="Validate it online">CSS3 valid</a>.</p>
            <p>This work is unofficial and is not liable for Gentleface.</p>
        </div>
    </header>
